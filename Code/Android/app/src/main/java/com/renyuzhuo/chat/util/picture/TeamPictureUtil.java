 ...
 */
public class TeamPictureUtil extends PictureUtil {

    private final ImageView imageView;
    private final int teamId;

    public TeamPictureUtil(ImageView imageView, int teamId) {
    ...
    public void completePut(final Context context, final String key, ResponseInfo info, JSONObject res) {
        ...
        try {
            ...
            NetOption.postDataToUrl(Global.UPDATE_TEAM_HEAP_URL, params, new NetOptionResponse() {
                @Override
